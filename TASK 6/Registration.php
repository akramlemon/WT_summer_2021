        ...
        <form>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="hobby" id="value1" value="Singing">
                    <label for="value1">Singing</label>
                    <input type="checkbox" name="hobby" id="value2" value="Dancing">
                    <label for="value2">Dancing</label>
                    <input type="checkbox" name="hobby" id="value3" value="Reading">
